...
int64_t CGHeroInstance::getSpellBonus(const CSpell * spell, int64_t base, const battle::Unit * affectedStack) const
{
...
int64_t CGHeroInstance::getSpecificSpellBonus(const CSpell * spell, int64_t base) const
{
